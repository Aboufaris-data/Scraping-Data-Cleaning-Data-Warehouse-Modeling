...
driver.get("https://www.avito.ma/fr/maroc/appartements-%C3%A0_vendre?rooms=1&bathrooms=1&has_price=true&price=100000-")
...
# save
with open(r"C:\Users\user\Desktop\Scraping, Data Cleaning & Data Warehouse Modeling\data\avito_data_clean.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f)
